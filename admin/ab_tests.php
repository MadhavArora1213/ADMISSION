...
<head>
    ...
    <style>
        ...
        .w-a { background: rgba(11,36,71,0.06); color: #0B2447; }
        .w-b { background: rgba(11,36,71,0.06); color: #0F172A; }
        .w-inconclusive { background: rgba(15,23,42,0.1); color: rgba(15,23,42,0.8); }
    </style>
</head>
<body>
