        ...
        <div class="content-area">
            ...
            <div class="panel">
                ...
                <form method="POST" style="margin-top:16px;">
                    ...
                    <?php if($edit): ?><a href="article_categories.php" class="btn" style="display:block;text-align:center;margin-top:8px;background:#f1f5f9;color:#475569;">Cancel</a><?php endif; ?>
                </form>
            </div>
