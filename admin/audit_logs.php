...
<head>
    ...
    <style>
        ...
        .mini-stat .sub { font-size: 0.78rem; color: var(--text-muted); margin-top: 2px; }
        ...
        .filter-bar select, .filter-bar input[type="text"], .filter-bar input[type="date"] {
            padding: 8px 12px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.85rem; outline: none; background: #fff;
        }
        .filter-bar select:focus, .filter-bar input:focus { border-color: var(--primary); }
        .btn { padding: 8px 18px; border-radius: 8px; border: none; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.2s; }
        ...
        .pagination { display: flex; gap: 4px; justify-content: center; margin-top: 20px; padding-bottom: 20px; }
