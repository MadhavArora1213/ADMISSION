            ...
            <div class="media-grid">
                ...
                <div class="media-card">
                    ...
                    <div class="media-info">
                        ...
                        <div class="meta">
                            <span class="badge" style="background:#e0e7ff;color:#3730a3;"><?php echo strtoupper($f['file_type']); ?></span>
                        ...
                        <div class="media-actions">
                            ...
                            <a href="?action=delete&id=<?php echo $f['id']; ?>" class="tab-link" style="font-size:.75rem; padding:4px 8px; color:#dc2626; border-color:#fca5a5;" onclick="return confirm('Delete?')"><i class="ph ph-trash"></i></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
