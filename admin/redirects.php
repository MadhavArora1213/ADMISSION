                    ...
                    <div style="overflow-x:auto;">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-weight:600; color:#dc2626;"><?php echo htmlspecialchars($r['redirect_from']); ?></td>
                                    <td style="font-weight:600; color:#166534;"><i class="ph ph-arrow-right"></i> <?php echo htmlspecialchars($r['redirect_to']); ?></td>
