...
<head>
    ...
    <style>
        ...
        .page-header { margin-bottom: 24px; gap: 12px; flex-wrap: wrap; }
        ...
        .btn-primary { background: var(--primary); color: white; border: none; padding: 10px 24px; border-radius: 8px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; white-space: nowrap; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .form-control { padding: 9px 12px; font-size: 0.88rem; }
