    ...
    <main class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card"><div class="num" style="color:#dc2626;"><?php echo $zeroRate; ?>%</div><div class="label">Zero Results Rate</div></div>
                <div class="stat-card">
                    <div class="num" style="color:#166534; font-size:1.5rem; display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-weight:600; color:var(--primary);">
                                        ...
                                        <?php if($rq['clicked_result_id']): ?> <i class="ph-fill ph-check-circle" style="color:#166534;" title="Clicked a result"></i><?php endif; ?>
                                        <?php if($rq['zero_results']): ?> <i class="ph-fill ph-warning-circle" style="color:#dc2626;" title="Zero results"></i><?php endif; ?>
                                    </td>
