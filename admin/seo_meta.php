            ...
            <div style="display:grid; grid-template-columns: 400px 1fr; gap:24px;">
                ...
                <div class="panel">
                    ...
                    <form method="POST" action="seo_meta.php">
                        ...
                        <?php if($edit_meta): ?>
                        <a href="seo_meta.php" class="btn" style="display:block; text-align:center; margin-top:10px; background:#f1f5f9; text-decoration:none; color:var(--text-color); padding:10px; border-radius:8px;">Cancel Edit</a>
                        <?php endif; ?>
                    </form>
                </div>
                    ...
                    <div style="overflow-x:auto;">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="badge" style="background:#e0e7ff;color:#3730a3;"><?php echo htmlspecialchars($r['page_type']); ?></span><br>
                                    ...
                                    <td><span class="badge" style="background:#f1f5f9;color:#475569;"><?php echo $r['robots_directive']; ?></span></td>
                                    <td><span class="badge" style="background:#dcfce7;color:#166534;"><?php echo $r['schema_type']; ?></span></td>
                                    <td>
                                        <a href="?edit_id=<?php echo $r['id']; ?>" style="color:var(--primary); margin-right:8px;"><i class="ph ph-pencil-simple"></i></a>
                                        <a href="?delete_id=<?php echo $r['id']; ?>" onclick="return confirm('Delete meta tag?');" style="color:#dc2626;"><i class="ph ph-trash"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
