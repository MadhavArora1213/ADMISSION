...
<head>
    ...
    <style>
        ...
        .vars-helper {font-size: 0.75rem; color: #64748b; background: #f8fafc; padding: 8px; border-radius: 6px; margin-top: 4px; font-family: monospace;}
    </style>
</head>
<body>
            ...
            <div style="display:grid; grid-template-columns: 400px 1fr; gap:24px;">
                ...
                <div class="panel">
                    ...
                    <form method="POST" action="seo_templates.php">
                        ...
                        <?php if($edit_tpl): ?>
                        <a href="seo_templates.php" class="btn" style="display:block; text-align:center; margin-top:10px; background:#f1f5f9; text-decoration:none; color:var(--text-color); padding:10px; border-radius:8px;">Cancel Edit</a>
                        <?php endif; ?>
                    </form>
                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge" style="background:#e0e7ff;color:#3730a3;"><?php echo ucfirst($t['data_source']); ?></span></td>
                                    <td style="font-family:monospace; font-size:0.8rem; color:#64748b;"><?php echo htmlspecialchars($t['template_slug_pattern']); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="?delete_id=<?php echo $t['id']; ?>" onclick="return confirm('Delete SEO template?');" style="color:#dc2626;"><i class="ph ph-trash"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
