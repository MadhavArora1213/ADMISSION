            ...
            <div style="display:grid; grid-template-columns: 350px 1fr; gap:24px;">
                ...
                <div class="panel">
                    ...
                    <form method="POST" action="sitemaps.php">
                        ...
                        <?php if($edit_sm): ?>
                        <a href="sitemaps.php" class="btn" style="display:block; text-align:center; margin-top:10px; background:#f1f5f9; text-decoration:none; color:var(--text-color); padding:10px; border-radius:8px;">Cancel Edit</a>
                        <?php endif; ?>
                    </form>
                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?generate_id=<?php echo $sm['id']; ?>" title="Generate Now" style="color:#16a34a; margin-right:8px;"><i class="ph ph-arrows-clockwise"></i></a>
                                        <a href="?edit_id=<?php echo $sm['id']; ?>" style="color:var(--primary); margin-right:8px;"><i class="ph ph-pencil-simple"></i></a>
                                        <a href="?delete_id=<?php echo $sm['id']; ?>" onclick="return confirm('Delete sitemap entry?');" style="color:#dc2626;"><i class="ph ph-trash"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
