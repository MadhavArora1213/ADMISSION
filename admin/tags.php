        ...
        <div class="content-area">
            ...
            <div class="panel">
                ...
                <form method="POST" style="margin-top:16px;">
                    ...
                    <?php if($edit): ?><a href="tags.php" class="btn" style="display:block;text-align:center;margin-top:8px;background:#F8FAFC;color:rgba(15,23,42,0.65);">Cancel</a><?php endif; ?>
                </form>
            </div>
            ...
            <div class="panel">
                ...
                <div class="tag-cloud">
                    ...
                    <div class="tag-pill">
                        ...
                        <a href="?action=delete&id=<?php echo $t['id']; ?>" style="color:#0F172A;text-decoration:none;" onclick="return confirm('Delete tag?')" title="Delete"><i class="ph ph-x" style="font-size:.85rem;"></i></a>
                    </div>
                    <?php endforeach; ?>
