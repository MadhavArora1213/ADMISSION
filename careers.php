...
<head>
  ...
  <title>Career Exploration Wizard | AdmissionSeason</title>
  <meta name="description" content="Discover your ideal career path. Take our interactive career selection assessment matching your streams and interests.">
...
<div class="container">
  <div class="stream-landing-container">
    ...
    <div class="stream-card">
      ...
      <a href="careers.php?stream=Science" class="stream-btn">Explore Science</a>
    </div>
    ...
    <div class="stream-card">
      ...
      <a href="careers.php?stream=Commerce" class="stream-btn">Explore Commerce</a>
    </div>
    ...
    <div class="stream-card">
      ...
      <a href="careers.php?stream=Humanities" class="stream-btn">Explore Humanities</a>
    </div>
...
<div class="container wizard-container">
  ...
  <div class="wizard-main">
    <div class="stream-nav-header">
      ...
      <a href="careers.php" class="change-stream-btn"><i class="ph ph-arrow-left"></i> Change Stream</a>
    </div>
        ...
        card.innerHTML = `
          ...
          <div class="career-body">
            ...
            <div class="career-meta-row">
              ...
              <a href="career_details.php?slug=${c.slug}" class="explore-link">Explore Path <i class="ph ph-arrow-right"></i></a>
            </div>
          </div>
        `;
