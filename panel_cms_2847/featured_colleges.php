...
// Fetch available colleges (not featured)
$availableColleges = $pdo->query("SELECT c.id, c.name, ci.name AS city_name, c.overall_rating_avg, c.ranking_nirf
    ...
    ORDER BY c.is_featured DESC, c.overall_rating_avg DESC, c.ranking_nirf ASC LIMIT 100")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="content-area">
                ...
                <div class="panel">
                    ...
                    <div style="text-align:center;padding:24px;color:#f59e0b;background:#fef3c7;border-radius:8px;">
                        <i class="ph ph-warning-circle" style="font-size:1.2rem;"></i> Maximum 6 featured colleges reached. Remove one first to add another.
                    </div>
                    <?php endif; ?>
                </div>
