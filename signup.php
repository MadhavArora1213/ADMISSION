  ...
  <div class="visual-section">
    ...
    <div class="vector-illustration">
      ...
      <svg class="connections" viewBox="0 0 300 140">
        <line x1="50" y1="100" x2="140" y2="35" stroke="rgba(11, 36, 71, 0.05)" stroke-width="1.5" stroke-dasharray="4"/>
        <line x1="140" y1="35" x2="230" y2="100" stroke="rgba(11, 36, 71, 0.05)" stroke-width="1.5" stroke-dasharray="4"/>
        <line x1="50" y1="100" x2="230" y2="100" stroke="rgba(11, 36, 71, 0.05)" stroke-width="1.5" stroke-dasharray="4"/>
      </svg>
    ...
    <?php else: ?>
      ...
      <form method="POST" action="">
        ...
        <div class="form-group-custom" style="max-width: 320px; margin: 0 auto 24px auto;">
          <input type="text" name="otp" class="input-card" placeholder="Enter OTP (e.g. 123456)" required pattern="^[0-9]{6}$" maxlength="6" autofocus style="letter-spacing: 6px; font-weight: 800; text-align: center; font-size: 1.1rem; background: rgba(255,255,255,0.5); border: 1px solid var(--border-glass);">
        </div>
